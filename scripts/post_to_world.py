...
requests.post('https://api.telegram.org/bot' + token_bot + '/sendMessage', data={'chat_id': '@maratonime', 'text': text_channel, 'parse_mode': 'Markdown'})

requests.post('https://graph.facebook.com/v2.11/maratonIME/feed', data={'message': text_page, 'access_token': token_page, 'link': link})
